...
function SetInstru2()
{
	if(PTBR)
	{
		I_background_image.src = "Images/Background/Instructions_2_Background.png";
	}
	else
	{
		I_background_image.src = "Images/Background/Instrucoes_2_Background.png";
	}
